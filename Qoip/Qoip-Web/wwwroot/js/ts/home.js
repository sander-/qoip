    ...
    methods: {
        fetchClientIpInfo() {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                try {
                    const response = yield axiosClient.get('/api/networkconnectivity/client-ip');
        ...
        fetchWhoisInfo(ipAddress) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                try {
                    const response = yield axiosClient.get(`/api/networkconnectivity/whois?ipAddress=${ipAddress}`);
